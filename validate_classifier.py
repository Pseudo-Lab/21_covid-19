...
def main():
    ...
    parser.add_argument('--out-path', type=str, default='tmp.csv')
...
def train(args, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    if args.local_rank in [-1, 0]:
        test_loss, test_acc, test_map = test(args, test_loader, test_model)
...
def test(args, test_loader, model):
    ...
    with open(args.out_path, 'w') as fs:
        for gt, ps in zip(ground_truth, probabilities):
            fs.write(f'{gt},{ps[0]:.4f},{ps[1]:.4f},{ps[2]:.4f},{ps[3]:.4f}\n')
